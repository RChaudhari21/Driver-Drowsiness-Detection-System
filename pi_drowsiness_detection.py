...
ap.add_argument("--cascade", default="./haarcascade_frontalface_default.xml",
    help = "path to where the face cascade resides")
ap.add_argument("--shape-predictor", default="./shape_predictor_68_face_landmarks.dat",
    help="path to facial landmark predictor")
ap.add_argument("--alarm", type=int, default=0,
...
while True:
    ...
    for (x, y, w, h) in rects:
        ...
        cv2.putText(frame, "EYE: {:.3f}".format(ear), (300, 30),
            cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
